...
const TYPES = [
  { value: 'attendance_present', label: 'حضور',                 icon: 'pi-check-circle',   color: '#10b981',
    ...
    fallback: 'مرحباً، {{اسم_الطالب}} كان {{الحضور}} في حصة {{عنوان_الحصة}} بتاريخ {{التاريخ}}.' },
  { value: 'attendance_absent',  label: 'غياب',                 icon: 'pi-times-circle',   color: '#ef4444',
    placeholders: ['{{كود_الطالب}}', '{{اسم_الطالب}}', '{{عنوان_الحصة}}', '{{الحضور}}', '{{التاريخ}}', ...COMMON_PLACEHOLDERS],
    fallback: 'تنبيه: {{اسم_الطالب}} كان {{الحضور}} عن حصة {{عنوان_الحصة}} بتاريخ {{التاريخ}}.' },
  { value: 'exam_grade_good',    label: 'درجة امتحان (ممتاز)',   icon: 'pi-star',           color: '#f59e0b',
    ...
    fallback: 'تهانينا! حصل {{اسم_الطالب}} على درجة {{الدرجة}} من {{الدرجة_الكلية}} في {{عنوان_الامتحان}}.' },
  { value: 'exam_grade_bad',     label: 'درجة امتحان (ضعيف)',    icon: 'pi-exclamation-triangle', color: '#ef4444',
    placeholders: ['{{كود_الطالب}}', '{{اسم_الطالب}}', '{{عنوان_الامتحان}}', '{{الدرجة}}', '{{الدرجة_الكلية}}', ...COMMON_PLACEHOLDERS],
    fallback: 'تنبيه: حصل {{اسم_الطالب}} على درجة ضعيفة {{الدرجة}} من {{الدرجة_الكلية}} في {{عنوان_الامتحان}}.' },
  { value: 'new_session',  label: 'حصة جديدة',             icon: 'pi-calendar',       color: '#3b82f6',
    placeholders: ['{{كود_الطالب}}', '{{اسم_الطالب}}', '{{اسم_المجموعة}}', '{{عنوان_الحصة}}', '{{التاريخ}}', ...COMMON_PLACEHOLDERS],
    fallback: 'تم إضافة حصة جديدة: {{عنوان_الحصة}} للمجموعة {{اسم_المجموعة}} بتاريخ {{التاريخ}}.' },
  { value: 'new_lecture',  label: 'محاضرة جديدة',           icon: 'pi-video',          color: '#ec4899',
    placeholders: ['{{كود_الطالب}}', '{{اسم_الطالب}}', '{{اسم_المجموعة}}', '{{عنوان_المحاضرة}}', '{{التاريخ}}', ...COMMON_PLACEHOLDERS],
    fallback: 'تم إضافة محاضرة جديدة: {{عنوان_المحاضرة}} للمجموعة {{اسم_المجموعة}} بتاريخ {{التاريخ}}.' },
  { value: 'payment_added',    label: 'إضافة دفعة',            icon: 'pi-money-bill',     color: '#10b981',
    placeholders: ['{{كود_الطالب}}', '{{اسم_الطالب}}', '{{قيمة_الدفعة}}', '{{تاريخ_الدفع}}', '{{الدرجة_الكلية}}', '{{المتبقي}}', ...COMMON_PLACEHOLDERS],
    fallback: 'تم استلام دفعة بقيمة {{قيمة_الدفعة}} من الطالب {{اسم_الطالب}} بتاريخ {{تاريخ_الدفع}}. المتبقي: {{المتبقي}}.' },
]
